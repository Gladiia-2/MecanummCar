...
int main(void)
{
  ...
  osThreadDef(pid, Task_Ser, osPriorityNormal, 0, 128);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, b1_Pin|b2_Pin|c1_Pin|c2_Pin
                          |d1_Pin|d2_Pin|a1_Pin|a2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : b1_Pin b2_Pin c1_Pin c2_Pin
                           d1_Pin d2_Pin a1_Pin a2_Pin */
  GPIO_InitStruct.Pin = b1_Pin|b2_Pin|c1_Pin|c2_Pin
                          |d1_Pin|d2_Pin|a1_Pin|a2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
__weak void Task_Control(void const * argument)
{
...
/* USER CODE BEGIN Header_Task_Ser */
/**
* @brief Function implementing the pid thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Task_Ser */
__weak void Task_Ser(void const * argument)
{
  /* USER CODE BEGIN Task_Ser */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END Task_Ser */
}

/* USER CODE BEGIN Header_PS2 */
/**
* @brief Function implementing the ps2 thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_PS2 */
__weak void PS2(void const * argument)
{
  /* USER CODE BEGIN PS2 */
  /* Infinite loop */
  for(;;)
